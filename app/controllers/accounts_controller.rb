class AccountsController < ApplicationController
  ...
  def account_params
   params.require(:account).permit(:email,:password, :password_confirmation,:firstname,:lastname, :middlename,:maidenname, :gender, :current_address,:homephone,:cellphone,:DOB)
  end
